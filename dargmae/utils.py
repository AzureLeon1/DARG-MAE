...
def build_args():
    ...
    parser.add_argument("--sub_mask_encoder", type=str, default="gat")
    ...
    parser.add_argument("--weight_decay_f", type=float,
                        default=1e-4, help="weight decay for evaluation")
    ...
    # ['max-mean','max-min', 'mean-min']
    parser.add_argument("--scale_type", type=str, default='max-mean')
    parser.add_argument("--use_log_degrees",
    ...
    parser.add_argument("--lr_sub_mask", type=float, default=0.001)
    parser.add_argument("--sub_mask_weight", type=float, default=0.5)
    ...
    parser.add_argument("--uniformity_dim", type=int, default=128)
    parser.add_argument("--lamda", type=float, default=0.005)
    parser.add_argument("--alpha_0", type=float, default=0.9)
    parser.add_argument("--alpha_T", type=float, default=1.0)
    parser.add_argument("--gamma", type=float, default=1.0)
    parser.add_argument("--load_data", type=bool, default=False)
    parser.add_argument("--sub_avg_node_num", type=int, default=7)
    parser.add_argument("--sub_num", type=int, default=None)
